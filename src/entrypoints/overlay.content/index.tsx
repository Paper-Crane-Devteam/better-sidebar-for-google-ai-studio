...
export default defineContentScript({
  ...
  async main() {
    console.log(
      'Better Sidebar for Google AI Studio: Overlay Content Script Initialized',
    );
    ...
    const hideNavbar = async () => {
      ...
      try {
        console.log(
          'Better Sidebar for Google AI Studio: Looking for ms-navbar...',
        );
        const navbar = await waitForElement('ms-navbar');
        console.log(
          'Better Sidebar for Google AI Studio: Found ms-navbar, hiding it.',
        );
        ...
        console.error(
          'Better Sidebar for Google AI Studio: Failed to find ms-navbar',
          e,
        );
      }
    };
    ...
    // 2. Inject SidePanel
    console.log(
      'Better Sidebar for Google AI Studio: Waiting for .makersuite-layout...',
    );
    const anchor = await waitForElement('.makersuite-layout');
    console.log(
      'Better Sidebar for Google AI Studio: Found .makersuite-layout',
      anchor,
    );
    ...
    const syncSidebarWithNavbar = async () => {
      try {
        console.log(
          'Better Sidebar for Google AI Studio: Waiting for ms-navbar to sync...',
        );
        const navbar = await waitForElement('ms-navbar');
        ...
        if (!firstChild) {
          console.warn(
            'Better Sidebar for Google AI Studio: ms-navbar has no first child',
          );
          return;
        }
        ...
        updateState();
        console.log(
          'Better Sidebar for Google AI Studio: Navbar sync initialized',
        );
      } catch (e) {
        console.error(
          'Better Sidebar for Google AI Studio: Failed to sync with navbar',
          e,
        );
      }
    };
    ...
    // Add Styles
    const style = document.createElement('style');
    style.id = 'better-sidebar-for-google-ai-studio-sidebar-styles';
    style.textContent = `
