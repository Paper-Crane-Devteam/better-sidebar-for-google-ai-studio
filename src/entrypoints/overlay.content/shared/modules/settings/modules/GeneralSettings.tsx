...
export const GeneralSettings = () => {
    ...
    const { 
        ...
        newChatBehavior, setNewChatBehavior,
        language, setLanguage,
        shortcuts, setShortcutVisible
    } = useSettingsStore();
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <div className="grid gap-4 py-4">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="min-w-[120px]">
                                <DropdownMenuRadioGroup 
                                    value={language} 
                                    onValueChange={(value) => {
                                        if (value === 'zh-CN' || value === 'zh-TW' || value === 'en' || value === 'ja' || value === 'pt' || value === 'es' || value === 'ru') {
                                            setLanguage(value);
                                        }
                                    }}
                                >
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <span className="text-sm font-medium">{t('settings.layoutDensity')}</span>
                            <p className="text-xs text-muted-foreground">{t('settings.layoutDensityDescription')}</p>
                        </div>
                         <div className="flex items-center gap-1 bg-muted/50 p-1 rounded-lg border">
                            <Button 
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <span className="text-sm font-medium">{t('settings.overlayPosition')}</span>
                            <p className="text-xs text-muted-foreground">{t('settings.overlayPositionDescription')}</p>
                        </div>
                         <div className="flex items-center gap-1 bg-muted/50 p-1 rounded-lg border">
                            <Button 
                                variant={overlayPosition === 'bottom-left' ? 'secondary' : 'ghost'} 
                                size="sm" 
                                className="h-7 px-3 text-xs" 
                            ...
                            >
                             ...
                             <Button 
                                variant={overlayPosition === 'bottom-right' ? 'secondary' : 'ghost'} 
                                size="sm" 
                                className="h-7 px-3 text-xs" 
            ...
            <div className="space-y-2">
                ...
                <div className="grid gap-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <label className="text-sm font-medium">{t('shortcuts.favorites')}</label>
                        </div>
                        <Switch 
                    ...
                    {platform === Platform.AI_STUDIO && (
                        <>
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <label className="text-sm font-medium">{t('shortcuts.build')}</label>
                                </div>
                                <Switch 
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <label className="text-sm font-medium">{t('shortcuts.dashboard')}</label>
                                </div>
                                <Switch 
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <label className="text-sm font-medium">{t('shortcuts.documentation')}</label>
                                </div>
                                <Switch 
                    ...
                    {platform === Platform.GEMINI && (
                        <>
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <label className="text-sm font-medium">{t('shortcuts.myStuff')}</label>
                                </div>
                                <Switch 
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <label className="text-sm font-medium">{t('shortcuts.gems')}</label>
                                </div>
                                <Switch 
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <label className="text-sm font-medium">{t('shortcuts.originalUI')}</label>
                        </div>
                        <Switch 
            ...
            <div className="space-y-2">
                ...
                <div className="grid gap-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <span className="text-sm font-medium">{t('settings.newChatBehavior')}</span>
                            <p className="text-xs text-muted-foreground">{t('settings.newChatBehaviorDescription')}</p>
                        </div>
                        <div className="flex items-center gap-1 bg-muted/50 p-1 rounded-lg border">
                             <Button 
                                variant={newChatBehavior === 'current-tab' ? 'secondary' : 'ghost'} 
                                size="sm" 
                                className="h-7 px-3 text-xs" 
